...
function moveWidgetToToolbar(config) {
    let { toolbarID, insertbefore, widgetId, toolbarWidgetId, forceMove, weakmap, onCustomizationChange } = config;
...
function setWidgetHeight(options, isToolbarheightReliable) {
    ...
    if (options.toolbarID) {
        // If a toolbarID is specified, do not bind the event listener in this method,
        // because the customization event will be added in moveWidgetToToolbar.
                ...
                if (config.toolbarID) {
                    ...
                    if (widget) {
                        ...
                        sstorage._toolbarwidgetState[config.toolbarWidgetId] = {
                            ...
                            currentSet: getCurrentSet(toolbar)
                        };
                    }
                }
